...
import { Activity, Box, FileText, BarChart3, Network, Terminal, BookOpen, Presentation, Settings, User, Shield, Heart } from "lucide-react";
...
const navItems = [
  ...
  { title: "NoMoreHunger", path: "/no-more-hunger", icon: Heart },
