...
import { Activity, Box, FileText, BarChart3, Network, Terminal, BookOpen, Presentation, Settings, User, Shield, Users, ExternalLink, Rocket } from "lucide-react";
...
const navItems = [
  ...
  { title: "Builder", path: "/builder", icon: Rocket },
